...
const FITRESULTS = {
    ...
    :mu=>FitResult("$BASE/results/fits/bdt_Mar12/nominal/mu.json"),
    :ele=>FitResult("$BASE/results/fits/bdt_Mar12/nominal/ele.json"),
    :combined=>FitResult("$BASE/results/fits/bdt_Mar12/nominal/combined.json")
