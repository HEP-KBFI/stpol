...
def get_fixed(channel, old = False):
    fixed = []
    if channel == "mu":
        ...
        fixed = ["mtw", "met", "isotropy", "top_mass", "ljet_pt"] # correct one
        if old == True:
            fixed = ["mu_mtw", "met", "isotropy", "top_mass", "ljet_pt", "ljet_mass"]
    ...
    if channel == "ele":
        ...
        #fixed = ["ele_mtw", "met", "top_mass", "bjet_pt", "isotropy", "top_eta"]
        fixed = ["met", "top_mass", "bjet_pt", "isotropy", "top_eta"]
        if old==True:
            fixed = ["met", "top_mass", "bjet_pt", "isotropy"] #old
...
def get_removed(channel):
    ...
    if channel == "mu":
        ...
        removed = ["mtw", "met", "ljet_pt", "top_mass", "bjet_pt", "c"]
    if channel == "ele":
