...
for channel in ["mu", "ele"]:
    for dataset, fileset in data_files.items():
        if not "TTJets" in dataset: continue
            ...
            for l in lst:
                ...
                for f in file_list:
                    ...
                    for base_file in fileset:
                        ...
                        batch_outfile.write("python $STPOL_DIR/src/pdf_uncertainties/calculate_NNPDF_CL.py " +dataset+ " " +l+ " " +str(i)+ " " +str(j)+" "+channel+" "+"/hdfs/cms/"+f+" "+base_file[0]+" "+base_file[1]+"\n")
