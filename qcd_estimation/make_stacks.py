...
variables = ["lepton_met_dr", "ljet_met_dr", "bjet_met_dr", "sjet1_met_dr", "sjet2_met_dr", "lepton_met_dphi", "ljet_dphi", "bjet_dphi", "jet1_met_dphi", "jet2_met_dphi", "ljet_met_dphi", "bjet_met_dphi"]#, "cos_theta_lj"
#]
...
def get_histos(fname, channel):
    ...
    #for cut in ["bdtcut","qcdcut", "nocut"]:
    for cut in ["nocut"]:
...
def make_stack(histos, channel, var, jt, cut, iso):
    ...
    for dataset in all_datasets_reproc:
        ...
        print dataset, h.GetEntries(), h.Integral()
        stack.Add(h)
        ...
        for channel in ["mu", "ele"]:
            ...
            for varname in variables:
                for jt in ["2j1t"]:#, "2j0t", "3j1t", "3j2t"]:
                    templates = {}
                    stacks = {}
                    for cut in ["nocut"]:#, "bdtcut", "nocut"]:#"qcdcut_new", "nocut", "reversecut", "bdtcut", "bdtcut_old"]:
